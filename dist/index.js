...
var MarkButton = reactI18next.withNamespaces()(component);
...
var QuestionEditInput = reactI18next.withNamespaces()(component$1);
...
var component$2 = function component(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(reactstrap.Input, { value: question.input, onChange: function onChange(event) {
          return _onChange(event.target.value);
        } })
    )
  );
...
var QuestionInput = connector.withAudio(component$2);
...
var MainInfo = reactI18next.withNamespaces()(component$5);
...
var QuestionList = reactI18next.withNamespaces()(component$6);
...
var Session = reactI18next.withNamespaces()(component$7);
...
var component$8 = function component(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          reactstrap.Label,
          { check: true },
          React.createElement(reactstrap.Input, { type: 'checkbox', onChange: function onChange() {
    ...
    React.createElement(
      reactstrap.FormGroup,
      null,
      React.createElement(reactstrap.Input, { type: 'number', placeholder: t('field.length'), value: length, onChange: _onChange, disabled: true })
    )
  );
};
...
var Settings = reactI18next.withNamespaces()(component$8);
...
var Submit = reactI18next.withNamespaces()(component$9);
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        reactstrap.Label,
        { check: true },
        React.createElement(reactstrap.Input, { type: 'radio', checked: value === 'limited', onChange: function onChange() {
    ...
    React.createElement(
      ...
      React.createElement(
        reactstrap.Label,
        { check: true },
        React.createElement(reactstrap.Input, { type: 'radio', checked: value === 'available', onChange: function onChange() {
...
var Visibility = reactI18next.withNamespaces()(component$a);
...
i18n.use(reactI18next.reactI18nextModule) // passes i18n down to react-i18next
.init({
  resources: {
    en: { translation: en },
    fr: { translation: fr }
